view: catalog_product_facts {
  ...
  measure: days_of_inventory_remaining {
    ...
    type: number
    value_format: "0"
    sql: CASE WHEN ${quantity_available_to_sell} > 0 AND ${days_of_inventory_calculation} IS NULL THEN 9999 ELSE ${days_of_inventory_calculation} END
      ;;
  }
  ...
  set: inventory_facts {
    fields: [products.budget_type, products.department, categories.category_1, total_sales_opportunity, percent_of_total_sales_opportunity, sell_through_rate, quantity_on_hand, quantity_sold_last_180_days, quantity_returned_last_180_days, net_sold_quantity_last_180_days, days_of_inventory_remaining]
  }
}
