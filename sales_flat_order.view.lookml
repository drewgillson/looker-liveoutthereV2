- view: sales_flat_order
  ...
  - dimension: base_customer_credit_amount
    type: number
    sql: ${TABLE}.base_customer_credit_amount

  - dimension: base_customer_credit_invoiced
    type: number
    sql: ${TABLE}.base_customer_credit_invoiced

  - dimension: base_customer_credit_refunded
    type: number
    sql: ${TABLE}.base_customer_credit_refunded
  ...
  - dimension: base_giftcert_amount_credited
    type: number
    sql: ${TABLE}.base_giftcert_amount_credited

  - dimension: base_giftcert_amount_invoiced
    type: number
    sql: ${TABLE}.base_giftcert_amount_invoiced
  ...
  - dimension: custom_storefront
    type: string
    sql: ${TABLE}.custom_storefront

  - dimension: customer_credit_amount
    type: number
    sql: ${TABLE}.customer_credit_amount

  - dimension: customer_credit_invoiced
    type: number
    sql: ${TABLE}.customer_credit_invoiced

  - dimension: customer_credit_refunded
    type: number
    sql: ${TABLE}.customer_credit_refunded
  ...
  - dimension: ebizmarts_magemonkey_campaign_id
    type: string
    sql: ${TABLE}.ebizmarts_magemonkey_campaign_id
  ...
  - dimension_group: estimated_shipping
    type: time
    timeframes: [time, date, week, month]
    sql: ${TABLE}.estimated_shipping_date
  ...
  - dimension_group: fullstock
    type: time
    timeframes: [time, date, week, month]
    sql: ${TABLE}.fullstock_date
  ...
  - dimension: giftcert_amount_credited
    type: number
    sql: ${TABLE}.giftcert_amount_credited

  - dimension: giftcert_amount_invoiced
    type: number
    sql: ${TABLE}.giftcert_amount_invoiced
  ...
  - dimension: marketplace_order_id
    type: string
    sql: ${TABLE}.marketplace_order_id

  - dimension: notified_cs
    type: number
    sql: ${TABLE}.notified_cs
  ...
  - dimension: payment_validated
    type: number
    sql: ${TABLE}.payment_validated
  ...
  - dimension: raf_credit_issued
    type: number
    sql: ${TABLE}.raf_credit_issued
  ...
  - dimension: stocks_updated
    type: number
    sql: ${TABLE}.stocks_updated
  ...
  - measure: count
    type: count
    drill_fields: [customer_firstname, customer_lastname, customer_middlename, store_name, coupon_rule_name]
