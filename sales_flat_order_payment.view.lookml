- view: sales_flat_order_payment
  sql_table_name: magento.sales_flat_order_payment
  fields:
  ...
  - dimension: optimal_create_profile
    type: number
    sql: ${TABLE}.optimal_create_profile

  - dimension: optimal_profile_id
    type: number
    sql: ${TABLE}.optimal_profile_id
