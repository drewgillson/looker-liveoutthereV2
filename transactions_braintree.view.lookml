- view: transactions_braintree
  ...
  sets:
    detail:
      ...
      - shipping_city_locality
      - shipping_state_province_region
      ...
      - pay_pal_payer_email
      - pay_pal_payment_id
      - pay_pal_authorization_id
      - pay_pal_debug_id
      - pay_pal_capture_id
      - pay_pal_refund_id
      - pay_pal_custom_field
      - pay_pal_payer_id
      - pay_pal_payer_first_name
      - pay_pal_payer_last_name
      - pay_pal_seller_protection_status
      - pay_pal_transaction_fee_amount
      - pay_pal_transaction_fee_currency_iso_code
